...
import 'package:kamachi_app_admin/Pages/EditPage.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                      padding: EdgeInsets.all(10.0),
                      child: Text(
                          'Complaint Type: ${list[index].complainttype} ')),
                  Padding(
                      padding: EdgeInsets.all(10.0),
                      child: Text('Priority:${list[index].priority}')),
                  Padding(
                      padding: EdgeInsets.all(10.0),
                      child: Text(
                          'Complaint Title:${list[index].complainttitle}')),
                  Padding(
                      padding: EdgeInsets.all(10.0),
                      child: Text('Submitted By: ${list[index].submittedby}')),
                  Padding(
                    padding: EdgeInsets.all(10.0),
                    child:
                        Text('Contact/Extension No.: ${list[index].contact}'),
                  ),
                  Padding(
                      padding: EdgeInsets.all(10.0),
                      child: Text('Division: ${list[index].division}')),
                  Padding(
                      padding: EdgeInsets.all(10.0),
                      child: Text('Department: ${list[index].department}')),
                  Padding(
                      padding: EdgeInsets.all(10.0),
                      child: Text('Assigned To: ${list[index].assignedto}')),
                  Padding(
                      padding: EdgeInsets.all(10.0),
