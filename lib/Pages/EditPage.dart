...
class _EditPageState extends State<EditPage> {
  ...
  TextEditingController complanttypecontroller;
  TextEditingController prioritycontroller;
  TextEditingController comptitlecontroller;
  ...
  void initState() {
    ...
    complanttypecontroller =
        TextEditingController(text: widget.report.complainttype);
    prioritycontroller = TextEditingController(text: widget.report.priority);
    comptitlecontroller =
    ...
    divcontroller = TextEditingController(text: widget.report.division);
    departcontroller = TextEditingController(text: widget.report.department);
    assignedcontroller = TextEditingController(text: widget.report.assignedto);
  ...
  update(String token) {
    ...
    if (widget.report.key != null) {
      dbRef.reference().child("reports/").child(widget.report.key).set({
        ...
        "complaint type": complanttypecontroller.text.toString(),
        "priority": prioritycontroller.text.toString(),
        "complaint title": comptitlecontroller.text.toString(),
        "submitted by": submitcontroller.text.toString(),
        "contact": contactcontroller.text.toString(),
        "division": divcontroller.text.toString(),
        "department": departcontroller.text.toString(),
        "assigned to": assignedcontroller.text.toString(),
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: DropdownButtonFormField(
                      value: complanttypecontroller.text,
                      ...
                      onChanged: (newValue) {
                        setState(() {
                          complanttypecontroller.text = newValue;
                        });
                      },
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: DropdownButtonFormField(
                      ...
                      onChanged: (String newValue) {
                        assignedcontroller.text = newValue;
                      },
                    ),
                  ),
                  Padding(
